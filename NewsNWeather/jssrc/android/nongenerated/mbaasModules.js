...
function initMbaas() {
    ...
    if (kony.os.deviceInfo().name == "iPhone" || kony.os.deviceInfo().name == "iPhone Simulator" || kony.os.deviceInfo().name == "iPad") kony.application.showLoadingScreen("sknLoading", "Please wait...", constants.LOADING_SCREEN_POSITION_ONLY_CENTER, true, true, {
        shouldShowLabelInBottom: true,
        separatorHeight: 30
    });
    else kony.application.showLoadingScreen("sknLoading", "Please wait...", constants.LOADING_SCREEN_POSITION_ONLY_CENTER, true, true, null);
    ...
    if (frmLogin.txtBoxUserName.text === "" || frmLogin.txtBoxUserName.text === null || frmLogin.txtBoxPassword.text === "" || frmLogin.txtBoxPassword.text === null) {
        ...
        try {
            ...
            identityInstance.login({
                "userid": frmLogin.txtBoxUserName.text,
                "password": frmLogin.txtBoxPassword.text
